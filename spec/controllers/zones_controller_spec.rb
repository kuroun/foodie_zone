  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:zone => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested zone" do
        zone = Zone.create! valid_attributes
        put :update, {:id => zone.to_param, :zone => new_attributes}, valid_session
        zone.reload
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        zone = Zone.create! valid_attributes
        put :update, {:id => zone.to_param, :zone => invalid_attributes}, valid_session
        expect(response).to be_success
      end
    end
  end
